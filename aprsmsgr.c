...
*/
	...
	/* 03Mar2023, Maiko, Trying to fix Message Text width, reported
	 * by Jean (VE2PKT), having a bit of trouble with this, good grief,
	 * nothing seems to be working in CSS, how to do this now ? Using
	 * the TH for top row does not help, but percentage does, yes !
