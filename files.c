...
/* 
 * 22Apr2022, Maiko, (VE4KLM), I need the userlookup function for
 * the new MIME awareness code - thanks Gus for noticing this :]
 *  (just leave these defined all the time, not just PPP)
 *
 #ifdef PPP
 */
