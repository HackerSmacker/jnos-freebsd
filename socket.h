 ...
 * Mods by PA0GRI
 *
 * Adding IPV6, this one mid Feb, 2023, by Maiko Langelaar, VE4KLM
 */
#ifndef _SOCKET_H
#define _SOCKET_H
...
#endif
#ifdef	EA5HVK_VARA
#define AF_VARA     7   /* New, 29Apr2023, Michael (WZ0C) */
#endif
...
/* In socket.c: */
extern int Vai_sock;    /* Socket listening to VARA (there can be only one) */
...
#ifdef	IPV6
/* 22Feb2023, Maiko, ipv6 version - used in tipmail.c for telnet IPV6 */
int new_start_tcpv6 (int16, char*, void (*task)(int, void*, void*), int, int);
#endif
