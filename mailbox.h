...
#define VARA_CMD      16777216L  /* 0x1000000 VARA gateway operation allowed */
...
#ifdef	DONT_COMPILE
/* 24Apr2023, Maiko, Using a *void to pass socket info, NOPE, make it static now */
#ifdef IPV6
int gw_connect __ARGS((struct mbx *m,int s, void *fsocket,int len));
#else
