...
extern unsigned char myipv6addr[16];	/* 12Apr2023, Maiko */

extern char *ipv6iface;	/* 16Apr2023, Maiko, Using it enough, should be in here */
...
/* 15May2023, Maiko (VE4KLM), this is called in udp.c as well */
